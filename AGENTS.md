...
- 精通R语言：tidyverse, data.table, ggplot2等
- 精通Julia：精通高性能科学计算
...
alias julia=/home/linuxbrew/.linuxbrew/bin/julia
```
...
- 禁止对/mnt/z，/mnt/z/GitHub执行全盘检索。先用 **autojump**：`zsh -lic 'j ModernHydro'`、`j ModelParams`等定位仓库根目录
